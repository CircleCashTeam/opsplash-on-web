...
const DDPH_MAGIC = 0x48504444; // b'DDPH'
...
export class OPPOSPlashImage {
    ...
    public getImageB64ByIndex(index: number) {
        return this.arrayBufferToBase64(this.getImageByIndex(index).buffer);
    }
    ...
    public changeImageByIndex(index: number, imageData: ImageData) {
        ...
        compdata[6] = 0;
        compdata[7] = 0;
        //(new DataView(compdata.buffer)).setUint32(0x4, 0x0, true)
        ...
        this.compData[index] = compdata.buffer;
